    ...
    lessons: [
      ...
      },
      {
        ...
        body: [
          ...
          'Mas antes de falar do múltiplo, preciso te ensinar o que 97% dos homens não sabem: como dar o PRIMEIRO orgasmo. Porque se você não consegue dar o primeiro, o múltiplo não existe. E aqui está a verdade que vai te chocar: a maioria das mulheres precisa de 15 a 20 minutos de estimulação consistente pra chegar ao orgasmo. A maioria dos homens dura 5. A matemática é simples — ele acaba antes de ela começar. É por isso que 70% fingem. Não por maldade. Porque o homem acabou e ela ainda nem chegou perto.',
          'A Técnica do Primeiro Orgasmo começa onde o Mapa do Corpo terminou. Depois de seguir as 4 zonas — pescoço, braços, lombar, coxas — você chega ao destino. Mas não vai direto ao clitóris. O clitóris tem 8.000 terminações nervosas — mais que qualquer outra parte do corpo humano. Estimular direto e forte no início causa desconforto, não prazer. A regra: comece indireto. Toque ao redor — os grandes lábios, a parte externa, a entrada da vagina. Toques leves, circulares, sem pressão. Deixe o clitóris ser atraído pra o estímulo, não forçado.',
          'A Escalada do Ritmo: depois de 3-5 minutos de estímulo indireto, quando o corpo dela estiver arqueando na sua direção — ela está pedindo mais — avance pro clitóris. Mas ainda indireto. Use os dedos ao redor, não em cima. Movimentos circulares, lentos, consistentes. A consistência é o segredo. O que faz a mulher chegar ao orgasmo não é a intensidade — é a constância. O mesmo ritmo, a mesma pressão, a mesma velocidade, por minutos seguidos. O homem que muda a cada 30 segundos não dá orgasmo. O que mantém o ritmo por 10, 15 minutos, dá.',
          'A Transição Direta: quando ela estiver molhada, respirando mais rápido, e o corpo estiver tremendo levemente, avance pro clitóris direto. Agora sim — toque direto, mas comece suave. Aumente a pressão gradualmente. Mantenha o movimento circular. Não acelere — mantenha. Se ela geme mais alto, arqueia mais, segura sua mão, você está no caminho. NÃO MUDA NADA. O erro mortal aqui é sentir que ela tá perto e acelerar ou aumentar a pressão. Isso quebra o padrão e reinicia o processo. Mantenha exatamente o que estava fazendo. O orgasmo dela é uma onda que precisa de constância pra quebrar.',
          'Os Sinais do Orgasmo Iminente: ela vai segurar a respiração ou respirar muito rápido. As pernas vão tremer. A vagina vai contrair levemente. As mãos dela vão agarrar o lençol, suas costas, qualquer coisa. Quando esses sinais aparecem, você está a 30-60 segundos do primeiro orgasmo. Mantenha. Não pare. Não mude. Não acelere. Mantenha exatamente o ritmo que a trouxe até aqui. E quando vier — o corpo dela vai contrair, arquear, ela vai gemer alto ou segurar a respiração e soltar — você segura firme. Mantém o contato. Deixa ela sentir a onda inteira. Esse é o primeiro orgasmo. O que a maioria dos homens nunca conseguiu dar de forma consistente.',
