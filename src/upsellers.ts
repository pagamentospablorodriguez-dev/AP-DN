...
export const UPSELLS_EXTRA: Upsell[] = [
  ...
  // ============================================================
  {
    key: 'd4',
    number: 'Downsell #4',
    title: 'O Mapa da Caçada — Versão Essencial (7 Passos, Sem Bônus)',
    subtitle:
      'Só o núcleo — os 7 passos do olhar até a cama, sem os bônus de Isolamento Avançado e Beijo Sem Rejeição Avançado. O protocolo principal, enxuto, por menos da metade do preço. Mesmo mapa, sem os complementos.',
    duration: '22 min',
    icon: 'eye',
    objective:
      'Entregar os 7 passos essenciais que levam do olhar dela até a cama — o núcleo do protocolo, sem os bônus avançados — para quem quer o mapa pelo menor valor.',
    lessons: [
      {
        heading: 'O essencial que muda tudo',
        body: [
          'Esta é a versão essencial — os 7 passos do olhar até a cama, sem os dois bônus avançados. O mesmo mapa, sem os complementos. O núcleo que faz o trabalho.',
          'Talvez o valor cheio tenha parecido muito agora. Talvez você esteja pensando "eu só quero a aura, já tá bom". Eu respeito. Mas preciso ser brutalmente honesto: a aura que você acabou de comprar vai funcionar. As mulheres vão te olhar. Os pescoços vão virar. Você vai sentir o poder. Mas sem saber o que fazer depois do olhar, você vai ser o cara mais magnético do bar que vai pra casa sozinho.',
          '83% dos homens que compram produtos de atração nunca transam por causa deles. Não porque o produto não funciona. Porque ninguém te ensinou os 7 passos entre o olhar e a cama. Esta versão essencial te entrega esses 7 passos — o núcleo, enxuto, sem os extras. Os mesmos passos que fazem o trabalho.',
        ],
      },
      {
        heading: 'Os 7 passos essenciais',
        body: [
          'Passo 1 — O Retorno do Olhar: quando ela olhar, segure 1-2 segundos, não desvie primeiro, solte devagar. O "solte devagar" causa o trava nela. Ela sente que você não queria ir, mesmo tendo ido. Esse é o passo que 70% dos homens erram — e errar aqui mata tudo antes de começar.',
          'Passo 2 — A Aproximação Sem Medo: aproxime em ângulo de 45 graus (lateral, nunca de frente), 20% mais devagar do que acha que deveria, com uma observação de ambiente — não uma pergunta sobre ela. "Esse lugar tem uma energia estranha hoje." Pare a 1 metro. Se ela recuar meio passo, fique. Se ela ficar estável, avance a conversa.',
          'Passo 3 — O Isolamento: não fique gritando no barulho. Diga "aqui tá impossível, vamos pra lá" — afirmação, não pergunta. Se ela hesitar, use o gancho de curiosidade: "tô te contando uma coisa que você precisa ouvir inteira, vem." Crie o espaço onde só existem vocês dois. Sem isolamento, nada avança.',
          'Passo 4 — A Escalada da Tensão: 4 camadas de toque — social (braço, breve), dirigido (segura 2s), cintura (guia o caminho), e o olhar de boca (desce o olhar à boca dela por 1s, volta). As 4 camadas constroem a tensão sem forçar. Sem elas, você fica na amizade. Com elas, o clima cresce sozinho.',
          'Passo 5 — O Beijo Sem Rejeição: identifique os 3 sinais — ela olha pra sua boca, faz silêncio carregado, não recua quando você se aproxima. Quando os 3 estão presentes, aja nos próximos 30 segundos. Aproxime 70% do caminho. Pare. Os últimos 30% são dela. Você oferece, não força. A rejeição quase não existe quando os 3 sinais confirmaram a janela.',
          'Passo 6 — O Pós-Beijo: não celebre. Não comente. Volte à conversa como se o beijo fosse natural. Mantenha o toque. Mude o tom — mais lento, mais baixo, mais próximo. O beijo é o início, não o pico. Quem trata o beijo como pico termina a noite aí. Quem trata como início continua.',
          'Passo 7 — A Condução: não diga "vamos pra minha casa". Diga "vou te mostrar [uma música / uma vista / meu dogue]." O motivo natural dá a ela uma razão social pra ir. Reduza a decisão: "tô indo, vem comigo" — não "quer ir?". Na chegada, não vá direto pro quarto. Água, música, 2 minutos de transição. Mulher acomodada no seu espaço é mulher que fica.',
        ],
      },
      {
        heading: 'A diferença entre a versão essencial e a completa',
        body: [
          'A versão essencial te entrega os 7 passos — o núcleo do protocolo. O que falta comparado à versão completa são os 2 bônus: o Protocolo do Isolamento Avançado (como arrancar ela de um grupo de amigas sem ela perceber, a técnica cirúrgica) e o Gatilho do Beijo Sem Rejeição Avançado (o movimento exato que faz ela já estar de olhos fechados antes de você chegar perto).',
          'Os 7 passos essenciais já cobrem cada etapa do caminho. Os bônus aprofundam as duas etapas mais críticas — o isolamento e o beijo. Se você quer o mapa completo pelo menor valor, esta versão te leva lá. Se depois quiser aprofundar, os bônus podem ser adicionados depois.',
          'O importante: você tem os 7 passos. Tem o caminho do olhar até a cama. Tem o que 97% dos homens não têm. O resto é refinamento — mas o núcleo está aqui, e o núcleo funciona.',
        ],
      },
    ],
    exercise: {
      title: 'Os 7 Passos Essenciais em 10 Dias',
      steps: [
        'Dias 1-3: treine os Passos 1 e 2 (olhar + aproximação) em qualquer interação social.',
        'Dias 4-5: pratique o Passo 3 (isolamento) — conduza conversas para cantos mais calmos.',
        'Dias 6-7: treine o Passo 4 (escalada) — as 4 camadas de toque, do social ao olhar de boca.',
        'Dia 8: estude os 3 sinais do Passo 5 (janela de beijo) — observe interações e identifique a janela.',
        'Dias 9-10: aplique os 7 passos completos numa interação real. Observe o fluxo.',
        'Ao final, você tem o núcleo instalado. Os 7 passos são o caminho — o resto é prática.',
      ],
    },
    takeaway:
      'Menos bônus, mesmo caminho. Os 7 passos essenciais já te levam do olhar dela até a cama. O núcleo está aqui — e o núcleo fecha.',
  },
  ...
  // ============================================================
  {
    key: 'd5',
    number: 'Downsell #5',
    title: 'O Protocolo da Dominação — Versão Essencial (Manual da Hora H, Sem Bônus)',
    subtitle:
      'Só o manual principal da Hora H — o protocolo de dominação, sem os bônus de Código do Orgasmo Múltiplo e Controle Predador avançado. O núcleo, enxuto, em parcelas que cabem no bolso. Mesma técnica central, sem os complementos.',
    duration: '30 min',
    icon: 'flame',
    objective:
      'Entregar o núcleo do Protocolo da Dominação — o manual principal da Hora H — sem os bônus avançados, para quem quer ser excepcional na cama pelo menor valor.',
    lessons: [
      {
        heading: 'A versão enxuta — o núcleo da Hora H',
        body: [
          'Esta é a versão essencial — o manual principal da Hora H, sem os dois bônus. O mesmo protocolo central que te leva de "ok" pra "bom de verdade", sem o Código do Orgasmo Múltiplo avançado e sem o Controle Predador avançado.',
          'Talvez o valor cheio tenha sido demais agora. Eu respeito. Mas preciso ser brutalmente honesto: 70% das mulheres já fingiram um orgasmo. E a maioria finge porque o homem na cama é medíocre — e ela quer acabar logo. Você pode ter a aura. Pode ter o mapa da caçada. Pode levar a mulher pra cama. Mas se na hora H você for como os outros 97% — rápido, sem técnica, sem controle — ela vai fingir que foi bom, ir pra casa, e nunca mais responder sua mensagem.',
          'Eu não vou deixar isso acontecer com você. Esta versão te entrega o núcleo — o manual principal da Hora H, sem os bônus. Mesma técnica central, sem os complementos. O que faz você sair de "ok" pra "bom de verdade".',
        ],
      },
      {
        heading: 'O manual essencial da Hora H',
        body: [
          'Controle Básico: a Técnica do Ponto de Não-Retorno. Durante o sexo, existe um ponto onde a ejaculação se torna inevitável. A maioria dos homens não sente esse ponto até ser tarde demais. O treinamento te ensina a senti-lo 10-15 segundos antes. Quando você sente, você reduz o ritmo, muda de posição, ou aplica a Técnica de Compressão (polegar e indicador na base da glande por 5-10 segundos). Em 7 dias de prática, 10 minutos por dia, você aprende a controlar. Em 30 dias, você dura o tempo que decidir.',
          'Respiração Predadora: a ejaculação rápida está ligada à respiração curta e rápida. A contra-técnica: respire lento e fundo, pelo nariz, 4 segundos inspirando, 6 soltando, durante todo o sexo. A respiração lenta ativa o parassimpático — o sistema que controla a calma. Calma = controle. Em 2 semanas, a respiração lenta vira automática, e o controle vira natural.',
          'O Mapa do Corpo Feminino — versão essencial: nunca vá direto ao destino. Siga a sequência de zonas — pescoço e nuca, parte interna dos braços, lombar, parte interna das coxas, e só então a zona central. Cada zona prepara a próxima. Pular zonas faz o corpo dela demorar mais a responder. Seguir a ordem faz o corpo inteiro se preparar — e quando você chega ao destino, a resposta é explosiva.',
          'A Presença Total: durante o sexo, não pense em nada. Não pense em durar. Não pense na próxima posição. Esteja. Sinta o corpo dela. Sinta a respiração dela. A atenção total comunica "eu estou aqui com você, completamente". Essa atenção é o que mais mulheres relatam como "o que faltava" — porque a maioria dos homens está na própria cabeça, não no momento.',
          'A Liderança Calma: você conduz. Não pergunta a cada segundo "tá bom assim?". Liderança calma é propor, observar a reação, ajustar. Se ela geme, continue. Se ela fica tensa, mude. A leitura do corpo dela substitui as perguntas. E a leitura comunica maestria.',
          'O Fim no Pico: quando decidir terminar, não termine no cansaço. Termine no pico. Quando ela estiver no orgasmo mais intenso, aí você termina junto. O fim no pico grava a noite inteira como "a melhor" — porque o cérebro grava o pico como a memória dominante. Termine no pico e ela lembra do pico. Para sempre.',
        ],
      },
      {
        heading: 'A diferença entre a versão essencial e a completa',
        body: [
          'A versão essencial te entrega o manual principal da Hora H — controle básico, respiração, mapa do corpo, presença, liderança, e fim no pico. O que falta comparado à versão completa são os 2 bônus: o Código do Orgasmo Múltiplo (a técnica que faz ela ter orgasmo após orgasmo) e o Controle Predador avançado (o método completo de 7 dias que reprograma o controle neuromuscular em profundidade).',
          'O manual essencial já te tira dos 97% e te coloca num nível que a maioria das mulheres nunca experimentou. Os bônus te levam ao nível dos 3% — o inesquecível, o que faz ela voltar sempre. Se você quer o núcleo pelo menor valor, esta versão te leva lá. Se depois quiser o nível máximo, os bônus podem ser adicionados depois.',
          'O importante: você tem o manual da Hora H. Tem o controle. Tem o mapa do corpo. Tem a presença. Tem o que 97% dos homens não têm. O resto é refinamento — mas o núcleo está aqui, e o núcleo já faz a diferença entre "ok" e "bom de verdade".',
        ],
      },
    ],
    exercise: {
      title: 'Os 21 Dias Essenciais da Hora H',
      steps: [
        'Dias 1-7: pratique o Controle Básico sozinho, 10 min/dia. Aprenda a sentir o ponto de não-retorno.',
        'Dias 1-7: pratique a Respiração Predadora (4s inspira, 6s solta) durante o dia todo.',
        'Dias 8-14: memorize o Mapa do Corpo Feminino. Pratique a sequência das 4 zonas em ordem.',
        'Dias 15-21: aplique tudo — controle + respiração + mapa + presença + fim no pico.',
        'Ao final, você não é mais "ok". Você é "bom de verdade". E ela sente a diferença.',
      ],
    },
    takeaway:
      'Sem os bônus, sem o preço cheio. Mas com o núcleo da Hora H — controle, mapa do corpo, presença. O que te tira dos 97% e te coloca num nível que ela nunca esquece.',
  },
];
